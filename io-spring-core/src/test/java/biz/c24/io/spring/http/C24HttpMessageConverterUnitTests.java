...
public class C24HttpMessageConverterUnitTests {
	...
	C24HttpMessageConverter converter = new C24HttpMessageConverter(model, DataFormat.XML);
	...
	public void cannotConvertNonMatchingMediaType() {
		C24HttpMessageConverter converter = new C24HttpMessageConverter(model, DataFormat.TEXT);
